              ...
              <div className="relative">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col md:flex-row gap-2 md:gap-10">
                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                      {/* Left Column - Poster Session spanning full height */}
                      <div className="bg-[#F3F3F3] p-4 md:h-full flex items-start">
                        <p className="font-inter text-sm text-[#0F1435]">Poster Session at Grimes Engineering Center</p>
                      </div>
                      {/* Right Column - Pitch and Meetup stacked */}
                      <div className="space-y-4">
                        <div className="bg-[#F3F3F3] p-4">
