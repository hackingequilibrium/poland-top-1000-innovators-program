                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="relative flex-grow group">
                    <input
                      ...
                      className="input-autofill-dark w-full bg-[#0a0a1a]/60 border border-white/15 rounded-xl px-5 py-3.5 text-sm text-white placeholder:text-white/40 focus:outline-none focus:border-white/15 focus:ring-0 transition-all backdrop-blur-sm"
                    />
                  </div>
                  <div className="relative flex-grow group">
                    <input
