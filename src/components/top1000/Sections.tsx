...
export const AboutSection = () => (
  <section id="about" className="bg-[#0B1A3F] px-10 md:px-16 pt-10 md:pt-14 pb-20 md:pb-24">
    <p className="text-white/70 text-base md:text-lg font-extralight leading-relaxed max-w-4xl">
